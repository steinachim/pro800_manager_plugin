...
void ProgramManagementTab::importPrograms()
{
    ...
    fileChooser->launchAsync (flags, [safeThis] (const juce::FileChooser& chooser) {
        ...
        {
            juce::AlertWindow::showMessageBoxAsync(juce::MessageBoxIconType::InfoIcon, "Import",
                "Imported " + juce::String(numImported) + " programs. " + juce::String(numSkipped) + " messages in the file are not valid Pro-800 programs and were skipped.");
        }
    });
}
