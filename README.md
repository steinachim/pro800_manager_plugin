...
## Known Limitations
 ...
 - Testing on different platforms is minimal. I'm mainly working on MacOS, so that will most likely work best. Windows/Linux builds are provided by automated GitHub workflows and are not guaranteed to be tested.
